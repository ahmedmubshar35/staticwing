...
const propulsionSteps = [
  {
    id: 1,
    tag: "Dual Electric Fan Intake",
    title: "Four Coordinated Electric Motors",
    bullets: [
      "Tandem dual-motor configuration at the front — **primary** and **secondary** fan",
      "Airflow from both motors merges in an **internal flow management system**",
      "Combined stream splits into **two distinct channels**",
    ],
    highlight: "4",
    highlightLabel: "Electric Motors",
  },
  {
    id: 2,
    tag: "Vertical Lift",
    ...
    bullets: [
      "**Aft curved flow path** redirects the lower airstream",
      "**41.5° deflection angle** produces the vertical thrust vector",
      "Enables **pure VTOL capability** — no runway required",
    ],
    highlight: "41.5°",
  ...
  },
  {
    ...
    bullets: [
      "**Elevon deflections** precisely modulated during liftoff & transition",
      "**Lateral counter-thruster fans** provide stabilizing forces",
      "Converts vertical lift into **controlled axial propulsion**",
    ],
    highlight: "2",
    highlightLabel: "Counter Thrust Fans",
  },
  {
    id: 4,
    ...
    bullets: [
      "**Unconventional airfoil geometry** mitigates classical stall behavior",
      "**Horizontal jet streams** and flow shielding keep airflow attached",
      "Preserves lift at **high angles of attack** and in crosswinds",
    ],
    highlight: "0",
  ...
  },
  {
    ...
    bullets: [
      "Propulsion, aerodynamic & control systems work **in coordination**",
      "Supports flight speeds up to **35 m/s**",
      "Stable across all phases — **VTOL to high-speed cruise**",
    ],
    highlight: "35",
                    ...
                    <ul className="space-y-2.5 mb-5">
                      {step.bullets.map((bullet, bulletIndex) => (
                        <li key={bulletIndex} className="flex items-start gap-2.5">
                          ...
                          <span className="font-inter text-text text-base leading-relaxed">
                            {renderBullet(bullet)}
                          </span>
                        </li>
                      ))}
              ...
              >
                <div className="relative bg-linear-to-br from-primary/10 via-surface/30 to-accent/10 rounded-2xl border border-accent/20 p-6 lg:p-8">
                  ...
                  <p className="font-inter text-text text-base leading-relaxed">
                    The coordinated interaction of all components from the dual-fan motor intake system to the actively controlled elevons, enables seamless transition from hover to cruise, ensuring stable flight and efficient performance throughout the aircraft&apos;s operational envelope.
                  </p>
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-5 pt-5 border-t border-white/10">
                    <div className="text-center">
                      ...
                      <span className="font-rajdhani text-xs text-text/60 uppercase">Electric Motors</span>
                    </div>
                    <div className="text-center">
