...
const propulsionSteps = [
  {
    ...
    description:
      "A tandem dual-electric motors configuration is installed at the front of the aircraft, consisting of a primary and a secondary fan motor. The airflow generated by both fan motors is directed into an internal flow management system where the streams combine before being divided into two distinct channels.",
    highlight: "4",
  ...
  },
  {
    ...
    description:
      "The aft curved flow path redirects the lower airstream at an angle of 41.5°, producing the vertical thrust vector necessary to achieve pure VTOL capability without runway requirement.",
    highlight: "41.5°",
  ...
  },
  {
    ...
    description:
      "During the liftoff and critical transition, elevon deflections are precisely modulated, while lateral counter-thruster fans provide stabilizing forces. Together, they convert vertical lift into controlled axial propulsion force, ensuring a seamless transition to forward flight.",
    highlight: "2",
  ...
  },
  {
    ...
    description:
      "The unconventional airfoil geometry mitigates classical stall behavior. Horizontal jet streams and flow shielding mechanisms help maintain attached airflow across the surface, preserving lift generation even at high angles of attack and cross wind conditions.",
    highlight: "0",
  ...
  },
  {
    ...
    description:
      "The coordinated performance of the propulsion, aerodynamic, and control systems supports flight speeds up to 35 m/s, ensuring stable flight across all phases, from VTOL to high-speed forward cruise.",
    highlight: "35",
