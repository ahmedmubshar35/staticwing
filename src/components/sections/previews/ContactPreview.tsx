          ...
          >
            <div className="relative w-full max-w-sm mx-auto lg:mx-0 bg-surface/30 rounded-2xl border border-white/10 p-6 overflow-hidden">
              ...
              <div className="relative z-10 flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-accent/10 border border-accent/30 rounded-xl flex items-center justify-center shrink-0">
              ...
              <div className="relative z-10 space-y-3">
                <div className="flex items-center gap-3 p-3 bg-background/40 rounded-xl border border-white/5">
                  ...
                  <div className="min-w-0">
                    <p className="font-rajdhani text-text/50 text-xs uppercase tracking-wider">Email</p>
                    <p className="font-inter text-sm text-white truncate">info@vtolution.co</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-background/40 rounded-xl border border-white/5">
                  ...
                  <div className="min-w-0">
                    <p className="font-rajdhani text-text/50 text-xs uppercase tracking-wider">Location</p>
                    <p className="font-inter text-sm text-white truncate">Manchester, UK</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-background/40 rounded-xl border border-white/5">
                  ...
                  <div className="min-w-0">
                    <p className="font-rajdhani text-text/50 text-xs uppercase tracking-wider">Response Time</p>
                    <p className="font-inter text-sm text-white truncate">Within 1–2 business days</p>
                  </div>
                </div>
              </div>
            </div>
